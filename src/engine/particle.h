...
class particle
{
    public:
        ...
        void setFadeOut( bool set) { p_fade = set; }
...
class particle_list
{
    public:
        ...
        int createParticel( particle_type type, fvec2 pos, fvec2 velocity, int lifetime, std::string data, fvec2 zoom = fvec2( 1, 1), bool asHUD = false, bool fadeOut = true);
